---
title: "主要樹種別素材生産量累年統計: 需要部門別 全国(昭和35年～平成25年)"
date:  "`r paste0('Original: 2017-02-08, ', 'Last Build: ', format(Sys.time(), '%Y-%m-%d'))`"
author: "Shinya Uryu"
output:
  html_notebook:
    df_print: paged
...
[![Binder](http://mybinder.org/badge.svg)](`r paste0("http://beta.mybinder.org/v2/gh/", "uribo/odkitchen/gh-pages?filepath=recipes/003/create_recipes.Rmd")` )
